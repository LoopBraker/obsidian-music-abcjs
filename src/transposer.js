...
exports.setSelectionToDegreeABC = exports.setNoteToDegree = exports.getScaleNote = exports.parseKey = exports.transposeABC = exports.ACCIDENTALS = exports.NOTE_VALUES = void 0;
 ...
 */
function transposeNote(token, semitones) {
    ...
    // 1. Base note value
    let baseVal = exports.NOTE_VALUES[baseNote]; // 0-23
    // 2. Accidental value
    let accVal = 0;
    if (accStr) {
        if (exports.ACCIDENTALS[accStr] !== undefined) {
            accVal = exports.ACCIDENTALS[accStr];
        }
        else {
            ...
            for (const char of accStr) {
                if (char === '^')
                    ...
                    accVal = 0; // Natural resets? usually = is just 0.
            }
        }
    }
 ...
 */
function transposeABC(input, semitones) {
    if (semitones === 0)
        return input;
...
exports.transposeABC = transposeABC;
function processUnprotectedText(text, semitones) {
...
function getScaleNote(root, mode, degree) {
    ...
    let rootVal = exports.NOTE_VALUES[rootBase];
    if (rootAcc === '#')
        rootVal += 1;
    if (rootAcc === 'b')
        rootVal -= 1;
...
exports.getScaleNote = getScaleNote;
/**
 * Sets a note to a specific scale degree.
 * Preserves the original octave range (C vs c vs c').
 */
function setNoteToDegree(noteToken, degree, keySignature) {
...
exports.setNoteToDegree = setNoteToDegree;
/**
 * Sets selected text to a scale degree.
 */
function setSelectionToDegreeABC(input, degree, keySignature) {
...
exports.setSelectionToDegreeABC = setSelectionToDegreeABC;
